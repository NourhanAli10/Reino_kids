    ...
    <div class="col-9 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                ...
                @endif
                <form class="forms-sample" method="POST" method="{{ route('dashboard.add-color') }}">
                    @csrf
                    <div class="form-group">
                        <label for="ColorName">Color Name</label>
                        <input type="text" name="name"class="form-control" id="ColorName" placeholder="Name"
                            value="{{ old('name') }}">
                        @error('name')
                    ...
                    {{-- <div class="form-group">
                        ...
                        <input type="color" name="code" class="form-control" id="ColorCode"
                            value="{{ old('code') }}">
                        @error('code')
                            <div class="text-danger font-weight-bold my-2">{{ $message }}</div>
                        @enderror
                    ...
                    <div class="form-group">
                        ...
                        <div class="color-picker">
                            ...
                            <input type="color" name="code" class="form-control" id="ColorCode" value="{{ old('code') }}">
                        </div>
                        @error('code')
                            <div class="text-danger font-weight-bold my-2">{{ $message }}</div>
                        @enderror
